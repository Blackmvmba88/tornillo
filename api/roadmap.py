...
ROADMAP = [
    {
        ...
        "deliverables": [
            {"component": "Detection API", "status": "completed"},
            {"component": "Runtime Engine", "status": "completed"},
            {"component": "Web Dashboard", "status": "completed"},
            {"component": "Mobile Capture", "status": "completed"},
            {"component": "Quality Inspection", "status": "completed"},
